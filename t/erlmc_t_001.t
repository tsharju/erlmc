...
main(_) ->
    ...
    (fun() ->
             ...
             etap:is(erlmc:has_server("localhost",11211), true, "has_server ok"),
             etap:is(erlmc:remove_server("localhost",11211), ok, "remove ok"),
             etap:is(erlmc:has_server("localhost",11211), false, "second has_server ok"),
